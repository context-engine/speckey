...
import type { FlowchartAST, FlowchartLink, FlowchartNode } from '@speckey/mermaid-ast';
...
const elk = new ELK({
  // @ts-expect-error FakeWorker implements the subset ELK needs but not the full Worker interface
